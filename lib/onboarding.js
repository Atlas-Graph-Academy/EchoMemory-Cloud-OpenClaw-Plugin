export function buildOnboardingText({ commandLabel, cfg }) {
  const blocks = [
    ...
    "4. The plugin verifies or creates your EchoMemory account, applies the OpenClaw onboarding shortcut automatically, creates a scoped `ec_...` API key, and writes it to `~/.openclaw/.env`.",
    "5. The local UI refreshes into connected mode. You do not need to open the website or create an API key manually.",
    "",
    "Manual fallback:",
