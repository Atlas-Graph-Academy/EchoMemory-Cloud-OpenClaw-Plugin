...
export function createEchoMemoryLocalUiTool({ getLocalUiUrl, commandLabel = "/echo-memory" }) {
  return {
    ...
    ownerOnly: true,
    description:
      "Get the live localhost URL for the Echo Memory local workspace UI, and optionally open it in the host machine's default browser.",
          ...
          content: [
            {
              ...
              text: [
                ...
                result.url,
                result.openedInBrowser ? "The default browser was opened on the host machine." : `You can also run \`${commandLabel} setup\`.`,
              ].join("\n"),
            },
          ],
          details: {
          ...
          content: [
            {
              ...
              text: [
                ...
                message,
                `Fallback: run \`${commandLabel} setup\` after fixing the local-ui install/build issue.`,
              ].join("\n"),
            },
          ],
          details: {
