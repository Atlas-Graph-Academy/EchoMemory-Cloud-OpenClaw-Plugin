...
export function createApiClient(cfg) {
  ...
  // Cached userId for account-switch detection. Populated by any call that
  // receives a user_id from the cloud (whoami, verifyOtp). Consumers stamp
  // this onto the sync state file so a later read can detect mismatches.
  ...
  async function whoami() {
    ...
    setLastKnownUserId(result?.user_id);
    return result;
  }
